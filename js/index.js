...
var App = {
    ...
    Notes:{
        Day01:()=>{
            $("#contentView").html(App.contents.d01);
        ...
        Day02:()=>{
            $("#contentView").html(App.contents.d02);
            $("#imgSide").css({
                "height":"330px",
                "width":"300px"
            });
        ...
        Day03:()=>{
            $("#contentView").html(App.contents.d03);
            $("#divideBox1").css({
                "width":"700px",
                "height":"405px"
            });
        ...
        Day04:()=>{
            $("#contentView").html(App.contents.d04);
        },
        Day05:()=>{
            $("#contentView").html(App.contents.d05);
        },
        Day06:()=>{
            $("#contentView").html(App.contents.d06);
        },
        Day07:()=>{
            $("#contentView").html(App.contents.d07);
        },
        Day08:()=>{
            $("#contentView").html(App.contents.d08);
        },
        Day09:()=>{
            $("#contentView").html(App.contents.d09);
        },
        Day10:()=>{
            $("#contentView").html(App.contents.d10);
        },
        Day11:()=>{
            $("#contentView").html(App.contents.d11);
        },
        Day12:()=>{
            $("#contentView").html(App.contents.d12);
        },
        Day13:()=>{
            $("#contentView").html(App.contents.d13);
        },
        Day14:()=>{
            $("#contentView").html(App.contents.d14);
        },
        Day15:()=>{
            $("#contentView").html(App.contents.d15);
        },
        Day16:()=>{
            $("#contentView").html(App.contents.d16);
        },
        Day17:()=>{
            $("#contentView").html(App.contents.d17);
        },
        Day18:()=>{
            let effInt = 0;
            let procInt = 0;
            ...
            $("#contentView").html(App.contents.d18);
